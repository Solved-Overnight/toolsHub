...
import { Beaker, FileText, Home, LogOut, ChevronLeft, ChevronRight, Settings, Book, BookOpen, Printer, Users, Facebook, Twitter, Instagram, Linkedin, Package, ShoppingCart, BarChart3, LayoutDashboard, ClipboardList } from 'lucide-react';
...
export function Sidebar({ isCollapsed, onCollapse, enabledMenuItems, menuOrder }: SidebarProps) {
  ...
  const allNavItems = [
    ...
    { name: 'Production Dashboard', icon: LayoutDashboard, path: '/production-dashboard', id: 'production-dashboard' },
    { name: 'Production Analyzer', icon: ClipboardList, path: '/production-analyzer', id: 'production-analyzer' },

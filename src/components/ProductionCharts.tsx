...
// Helper functions to get CSS API variables
const getGridColor = () => getComputedStyle(document.documentElement).getPropertyValue('--border').trim() || '#e2e8f0';
const getTextColor = () => getComputedStyle(document.documentElement).getPropertyValue('--muted-foreground').trim() || '#94a3b8';
const getCardColor = () => getComputedStyle(document.documentElement).getPropertyValue('--card').trim() || '#ffffff';
const getAccentColor = () => getComputedStyle(document.documentElement).getPropertyValue('--primary').trim() || '#6366f1';
const getMainTextColor = () => getComputedStyle(document.documentElement).getPropertyValue('--foreground').trim() || '#0f172a';
